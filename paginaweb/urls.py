...
urlpatterns = [
    ...
    path('pqrs/', views.PublicCreatePqrsView.as_view(), name='paginaweb-public-pqrs-create'),
    path('pqrs/rastrear/', views.PublicTrackPqrsView.as_view(), name='paginaweb-public-pqrs-track'),
