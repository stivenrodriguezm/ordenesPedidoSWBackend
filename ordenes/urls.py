...
from .views import (
    ...
    listar_comprobantes_egreso, crear_comprobante_egreso, siguiente_numero_comprobante_egreso, confirmar_comprobante_egreso, crear_recibo_caja,
    confirmar_pago_recibo, listar_vendedores, UserDetailView, cambiar_contrasena,
...
urlpatterns = [
    ...
    path('comprobantes-egreso/siguiente-numero/', siguiente_numero_comprobante_egreso, name='siguiente-numero-comprobante-egreso'),
